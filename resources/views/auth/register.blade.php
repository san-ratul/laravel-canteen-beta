            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="advance_payment" class="col-md-4 col-form-label text-md-right">{{ __('Advance Payment') }}</label>

                            <div class="col-md-6">
                                <input id="advance_payment" type="text" class="form-control{{ $errors->has('advance_payment') ? ' is-invalid' : '' }}" name="advance_payment" value="{{ old('advance_payment') }}" required autofocus>

                                @if ($errors->has('advance_payment'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('advance_payment') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
